...
def add_employee(client):
    return client.post('/create', data=dict(
        ...
        employee_age=23,
        employee_email="something@something.com",
        employee_phone="809-888-1245",
        employee_address="56 estweeod road",
        employee_gender="male",
        date_hired="March 4, 2021"
    ), follow_redirects=True)
...
def edit_employee(client):
    return client.post('/edit/A01', data=dict(
        ...
        employee_age=24,
        employee_email="something222@something.com",
        employee_phone="809-000-1245",
        employee_address="156 elmwood road",
        employee_gender="male",
        date_hired="March 22, 2021"
    ), follow_redirects=True)
...
def test_create_admin_post(client):
    ...
    assert add_db(client, "Test_User", "Test_Pass",
                  "Test_DB").status_code == 201
...
def test_delete_admin(client):
    ...
    assert delete_db(client, "Test_User", "Test_Pass",
                     "Test_DB").status_code == 201
    assert delete_db(client, "Invalid", "Invalid",
